(function(){
    ...
    const audioIn = new Audio('js/popin.mp3');
    const audioIn1 = new Audio('js/popin.mp3');
    const audioIn2 = new Audio('js/popin.mp3');

    const audioOut = new Audio('js/popout.mp3');
    const audioOut1 = new Audio('js/popout.mp3');
    const audioOut2 = new Audio('js/popout.mp3');
